...
//  $user->setUser_fullname($_SESSION['name']);
//  $user->setUser_permission($_SESSION['permis']);
//  $ul = new UserLibrary();
//  echo $ul->viewInfoUser($user);
//  echo $ul->viewEditUser($user);
// ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  ?>
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="post" action="../../ads/Book/">
        <input type="text" name="txtName" placeholder="Tìm kiếm sách"  title="Enter search keyword">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../../lib/imgs/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../../lib/imgs/messages-2.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../../lib/imgs/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../../../lib/imgs/profile-img.jpg" alt="Profile" class="rounded-circle">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" data-bs-toggle=\"modal\" data-bs-target="infoUser<?php echo $_SESSION['id'] ?>">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" data-bs-toggle=\"modal\" data-bs-target="editUser<?php echo $_SESSION['id'] ?>">
